...
> 修订 2026-09-24：WhatsNew 新版已部署到生产 NAS（地址同 settings.whatsnewBaseURL，未变），生产 lookup 冒烟通过（series matched/unmatched 语义、movie doubanRating 7.8/365671 + 4 信号）；WhatShot 端追剧反查自动生效，部署过渡结束。
